            ...
            <div>
                ...
                <div className={"col-sm-6"}>
                    ...
                    <p>
                        ...
                        <em> bildungsroman.</em> But I think it is at once strange and unfortunate
                        that
                        we have no such word to describe a category of research or writing that
                        traces
                        the development of a real-life reader of a novel. This glaring lacuna might
                        be a
                        consequence of the fact that we just do not have that kind of data. That is,
                        we
                        do not know enough about if, how, or how much a reader evolves via each
                        encounter with a text. In a time when it seems that bigots are getting
                        bolder
                        and louder all while basically insisting that they are surfeited with
                        learning
                        new things, which could actually help make them more tolerant (and
                        tolerable)
                        ...
                        attempt to answer the following questions: If we can understand the outcomes
                        of
                        re-reading a text, then what might we be able to deduce about how formative
                        a
                        text really is and how people think differently, change their minds, or
                        become
                    ...
                    <ul>
                        ...
                        <li>
                            How many re-readings and over the course of how long a period of time
                            does
                            it take to generate different meanings of one text? Is there a way to
                            direct
                        ...
                        <li>
                            ...
                            time—whether with respect to age, mentality, political perspective,
                            gender,
                            etc.?
                        </li>
                    </ul>
                    <p>
                        ...
                        transform into better readers can become less about trying to get people
                        to read
                        <em> more</em> and perhaps more about trying to get people to read, again
                        and
                        again (and at different stages in their lives), some of the texts already in
                        their stock of
                        texts to read. Indeed, while reproducibility is a scientific aspiration
                        required
                        to conduct scientific experiments, the kind of repetition with a difference
                        that
                        I hope to study here underscores not only how different the Humanities is
                        from
                        the Sciences but also how the Humanities <em> needs</em> to be different
                        from
                        scientific
                        ...
                        instructors who want and need to make the texts that they re-teach, year in
                        and
                        year out, “come alive” not only for their students but also for themselves;
                        to
        ...
        return(
            <div>
                ...
                <div className={"col-sm-6"}>
                    ...
                    <p>
                        Since the form that most of Toni Morrison’s works of fiction take is the
                        novel,
                        her only published short story, which never developed into a full-blown
                        novel,
                        represents a special case. By the time of “Recitatif”’s publication debut,
                        Morrison had already published four of what would eventually be eleven of
                        her
                        known novels. “Recitatif” would have gone down in history as her only
                        published
                        short story were it not for the publication, in February 2015, of
                        “Sweetness,”
                        an excerpt of her then upcoming novel God Help the Child, which was released
                        in
                        April 2015. So, since it wouldn’t be another thirty-two years before she
                        wrote
                        another “short story,” Morrison, more than anyone, seems particularly aware
                        of
                        ...
                        understood that the form ideally suited for the re-readings that this
                        narrative
                    ...
                    <h3>
                        Why is “Recitatif” particularly appropriate for a project about
                        re-rereading?
                    </h3>
                    <ul>
                        <li>
                            After completing a first reading of the story, the revelation about the
                            narrative experiment encourages a rereading; it encourages readers
                            to do a
                        ...
                        <li>
                            ...
                            conclusions we jump to about characters a direct reflection of how
                            we read
                        ...
                        <li>
                            ...
                            anything, does this new short story have to do with Morrison’s
                            <em>ur</em>
                            -short story?
                        </li>
                        <li>
                            ...
                            Maggie.
                            Such memory lapses suggest their unreliability as the tellers of
                            Maggie’s
                            story and of the story of “Recitatif” itself, which puts the onus on the
                            reader to be a more careful reader than they otherwise would have
                            needed to
                            be.
                        </li>
                    </ul>
